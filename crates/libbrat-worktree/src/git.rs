...
worktree /home/user/repo/.gritee/worktrees/s-20250117-a2f9
HEAD def456abc123
detached
"#;
        ...
        assert_eq!(
            entries[1].path,
            PathBuf::from("/home/user/repo/.gritee/worktrees/s-20250117-a2f9")
        );
    ...
    fn test_parse_porcelain_with_locked() {
        let output = r#"worktree /home/user/repo/.gritee/worktrees/test
HEAD abc123
detached
locked
"#;
