//! Grit integration library for Brat.
//!
//! This crate provides a client for interacting with the Grit CLI
//! to manage convoys and tasks.
//!
//! # Example
//!
//! ```ignore
//! use libbrat_grit::{GritClient, TaskStatus};
//!
//! let client = GritClient::new("/path/to/repo");
//!
//! // Create a convoy
...
pub use client::{GritClient, LockResult};
