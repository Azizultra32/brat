...
-   :material-numeric-2-circle:{ .lg .middle } **Quickstart**
...
-   :material-numeric-3-circle:{ .lg .middle } **Your First Convoy**

    ---

    Create a convoy with the Mayor and spawn agents to work on tasks.

    [:octicons-arrow-right-24: Tutorial](first-convoy.md)
...
- [Concepts](../concepts/index.md) - Understand how Brat works
- [User Guides](../guides/index.md) - Deep dives into specific features
- [Configuration](../configuration/index.md) - Customize Brat for your workflow
